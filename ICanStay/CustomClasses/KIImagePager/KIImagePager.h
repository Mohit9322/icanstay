...
-(void)imagePager:(KIImagePager *)imagePager signUpButtonPressed:(id)sender;
-(void)imagePager:(KIImagePager *)imagePager LoginButtonPressed:(id)sender;
-(void)imagePager:(KIImagePager *)imagePager skipButtonPressed:(id)sender;
@end
...
@property (strong, nonatomic)  UILabel         *welcomeLbl;
@property (strong, nonatomic)  UILabel         *dreamGateWayLbl;
@property (strong, nonatomic)  UILabel         *dreamGateWayLbl1;
@property (strong, nonatomic)  UIButton        *loginButton;
@property (strong, nonatomic)  UIButton        *signupBtn;

@property (strong, nonatomic)  UILabel         *luxHotlStayLbl;
@property (strong, nonatomic)  UILabel         *priceLblBigFont;
