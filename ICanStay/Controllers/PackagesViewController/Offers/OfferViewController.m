...
@interface OfferViewController ()<UIWebViewDelegate>
...
- (void)viewDidLoad {
    ...
    self.packageWebView = [[UIWebView alloc] init];     NSString *url=@"https://www.icanstay.com/offers";
    ...
    self.packageWebView.frame = CGRectMake(0, -10 , screenRect.size.width, screenRect.size.height );
