...
@interface ReferAndEarnWeb ()<UIWebViewDelegate>
...
@implementation ReferAndEarnWeb
...
- (void)viewDidLoad {
    ...
    NSString *url=@"https://www.icanstay.com/refer-and-earn";
    ...
    if ([globals.isFromHomeScreenToPackageScreen isEqualToString:@"YES"]) {
        self.packageWebView.frame = CGRectMake(0, - 50, screenRect.size.width, screenRect.size.height + 50);
    }else {
        self.packageWebView.frame = CGRectMake(0, -50, screenRect.size.width, screenRect.size.height +50 );
