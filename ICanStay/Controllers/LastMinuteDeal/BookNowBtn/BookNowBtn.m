...
//}
//-(void)setCityCeo:(NSString *)cityCeo   {
//    _CityCeoStr = cityCeo;
//}

- (void)dealloc{
    _hotelIdStr = nil;
    _hotelOfferPrice = nil;
    _cityCeo = nil;
    _cityID = nil;
}
...
- (void)useRedDeleteStyle
{
    ...
    color = [UIColor colorWithRed:0.592 green:0.0 blue:0.0 alpha:1.0];
    [colors addObject:(id)[color CGColor]];
    self.normalGradientColors = [NSArray arrayWithObjects:(id)([self colorFromHexString:@"#ffef9e"].CGColor),(id)([self colorFromHexString:@"#c7a75e"].CGColor),nil];
    self.normalGradientLocations = [NSArray arrayWithObjects:
                                    [NSNumber numberWithFloat:0.0f],
                                    [NSNumber numberWithFloat:1.0f],
                                    [NSNumber numberWithFloat:10.582f],
    ...
    self.highlightGradientColors = [NSArray arrayWithObjects:(id)([self colorFromHexString:@"#9a782a"].CGColor),(id)([self colorFromHexString:@"#f7e595"].CGColor),nil];
    self.highlightGradientLocations = [NSArray arrayWithObjects:
                                       [NSNumber numberWithFloat:1.0f],
                                       [NSNumber numberWithFloat:1.0f],
                                       [NSNumber numberWithFloat:1.51f],
                                       [NSNumber numberWithFloat:0.654f],
                                       nil];
